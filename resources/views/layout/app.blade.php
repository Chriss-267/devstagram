    ...
    <body class="bg-gray-100">
        ...
        <header class="p-5 border-b bg-white shadow">
            <div class="container mx-auto flex justify-between items-center">
                ...
                @auth
                    <nav class="flex gap-2 items-center">
                        ...
                        <form action="{{route("logout")}}" method="POST">
                            @csrf
                            <button type="submit" class="font-bold text-gray-600 uppercase text-sm">Cerrar Sesion</button>
                ...
                @guest
                    <nav class="flex gap-2 items-center">
                        <a class="font-bold text-gray-600 uppercase text-sm" href="{{route("login")}}">Login</a>
                        <a class="font-bold text-gray-600 uppercase text-sm" href="{{route("register")}}">Crear cuenta</a>
                    </nav>
                @endguest
        ...
        <main class="w-[80vw] mx-auto mt-10">
